...
const About: React.FC = () => {
  // Fecha fija de creación de la app (UTC)
  const createdAt = new Date('2025-08-08T00:00:00Z');
  const exact = createdAt.toLocaleString('es-ES', {
      ...
      <Card className="w-full max-w-xl p-6 sm:p-8 text-center">
        ...
        <div className="mt-6 grid gap-3">
          <div className="flex items-center justify-center gap-2 text-sm sm:text-base">
            ...
            <span><span className="font-semibold">Fecha de creación:</span> {exact}</span>
          </div>
          <a
